...
<div>
  ...
  <hr>
  <form class="row" @keyup.enter="searchOrders">
    ...
    <div class="form-group col-md-6 col-lg-3">
      <label for="input-search-member">社员</label>
      <select class="form-control" id="input-search-member" name="member_id" v-model="form.member_id">
        <option value="">- 查看全部 -</option>
...
export default {
  ...
  data () {
    return {
      api: '/api/order_statistics/member_daily',
      form: {
        department_id: '',
        member_id: '',
